...
func addReleaseToPlugins(releaseEvent PluginReleaseEvent, existingPlugins []Plugin) []Plugin {
    ...
    release.Url = "https://github.com/" + releaseEvent.ReleaseOrg + "/" + releaseEvent.ReleaseRepo + "/releases/download/v" + release.Version + "/" + releaseEvent.Repo + "-" + release.Version + ".zip"
